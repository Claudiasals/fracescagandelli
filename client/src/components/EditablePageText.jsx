...
const EditablePageText = ({
  ...
  return (
    <textarea
      ...
      rows={1}
      spellCheck={false}
      className={`editable-page-text-inner w-full max-w-full min-h-[1.35em] min-w-0 resize-none overflow-hidden border-0 bg-transparent py-0 pe-0 outline-none whitespace-pre-wrap break-words ${className}`}
    />
  );
};
